...
{
    public partial class FesSongInputSongNumber : FormBase
    {
        ...
        public FesSongInputSongNumber(EnumInputTypeName inputType, EnumInputNumberType inputTypeNumber)
        {
            InitializeComponent();
            dtgSongNumber.Focus();
            inputNumberType = inputTypeNumber;
        ...
        private void InsertWorkTableTmp()
        {
            try
            {
                ...
                // Truncate table work EnumInputTypeName inputType
                fesSongAddDeleteBusiness.InsertInputNumberToWorkTable(inputTypeName, inputNumberType, songNumberList);
