...
namespace Festival.Base
{
    public class FilterDataGridViewColumnHeader : DataGridViewColumnHeaderCell
    {
        ...
        public FilterDataGridViewColumnHeader(DataGridViewColumnHeaderCell oldHeaderCell)
        {
            ...
            FilterDataGridViewColumnHeader filterCell =
                oldHeaderCell as FilterDataGridViewColumnHeader;
            if (filterCell != null)
            {
        ...
        /// class. 
        /// </summary>
        public FilterDataGridViewColumnHeader(FilterDataGridViewColumnHeader oldHeaderCell)
        {
            this.ContextMenuStrip = oldHeaderCell.ContextMenuStrip;
            this.ErrorText = oldHeaderCell.ErrorText;
            this.Tag = oldHeaderCell.Tag;
        ...
        {
            return new FilterDataGridViewColumnHeader(this);
        }
        ...
        private void VerifyDataSource()
        {
            ...
            data.DataSource = this.DataGridView.DataSource;
        ...
        private void ResetFilter()
        {
            ...
            source.DataSource = this.DataGridView.DataSource;
                ...
                if (ictd != null)
                {
                    ...
                    foreach (PropertyDescriptor property in properties)
                    {
                            ...
                            System.Globalization.CultureInfo.InvariantCulture) == 0)
                        {
                            ...
                            if (value != DBNull.Value && value != null && this.OwningColumn.CellType.Equals(typeof(DataGridViewDateTimeInputCell)))
                            {
        ...
        private void UpdateFilter()
        {
            ...
            bs.DataSource = this.DataGridView.DataSource;
            IBindingListView data = (IBindingListView)bs;
        ...
        public static void RemoveFilter(DataGridView dataGridView)
        {
            ...
            BindingSource data = new BindingSource();
            data.DataSource = dataGridView.DataSource;
