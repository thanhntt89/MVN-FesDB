...
namespace FestivalBusiness
{
    public class FesContentQuery
    {
        ...
        public static string GetSaveUpdateDataFescontentQuery()
        {
           ...
           //query = string.Format("select [デジドココンテンツID] ,[アップ予定日] ,[サービス発表日],[ライツ用サービス発表日] ,[検索表示可否フラグ] ,[取消フラグ] ,[停止日] ,[削除情報] ,[録画可否フラグ] ,[録音可否フラグ] ,[有料コンテンツフラグ] ,[チャプターフラグ]    ,[著作権備考] ,[備考]  ,[Fesアレンジコード] ,[楽曲名邦題] ,[邦題優先フラグ],[曲名補正] ,[かなNULLフラグ] ,[曲名よみがな補正] ,[曲名ソート補正] ,[曲名ソート英字補正] ,[歌手ID補正] ,[映像区分] ,[Wii(デジドコ)選曲番号] ,[表示用Fesアレンジコード] ,[INTRO_TYPE補正] ,[新譜本扱月] ,[演奏時間補正] ,[支援レベル] from WiiTmp.dbo.[tbl_Wrk_Fesコンテンツ_{0}] where [更新日時] is not null order by [Wii(デジドコ)選曲番号] ", Environment.MachineName.Replace("-", "_"));

            query = string.Format("select [デジドココンテンツID] ,[アップ予定日] ,[サービス発表日],[ライツ用サービス発表日] ,[検索表示可否フラグ] ,[取消フラグ] ,[停止日] ,[削除情報] ,[録画可否フラグ] ,[録音可否フラグ] ,[有料コンテンツフラグ] ,[チャプターフラグ]    ,[著作権備考] ,[備考]  ,[Fesアレンジコード] ,[楽曲名邦題] ,[邦題優先フラグ],[曲名補正] ,[かなNULLフラグ] ,[曲名よみがな補正] ,[曲名ソート補正] ,[曲名ソート英字補正] ,[歌手ID補正] ,[映像区分] ,[Wii(デジドコ)選曲番号] ,[表示用Fesアレンジコード] ,[INTRO_TYPE補正] ,[新譜本扱月] ,[演奏時間補正] ,[支援レベル],[背景映像コード] from WiiTmp.dbo.[tbl_Wrk_Fesコンテンツ_{0}] where [更新日時] is not null order by [Wii(デジドコ)選曲番号] ", Environment.MachineName.Replace("-", "_"));
        ...
        internal static string GetInserFestContentQuery(DataTable dtFesServiceTable)
        {
            DataRow row = dtFesServiceTable.Rows[0];
